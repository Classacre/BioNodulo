  ...
  const parse = async () => {
    ...
    try {
      ...
      try {
        ...
        alert('Could not parse the workflow. Ensure the format is correct.');
      }
    } catch {
      try {
        const wf = JSON.parse(source) as Workflow;
        ...
        alert('Could not parse the workflow.');
      }
    }
    setParsing(false);
  };
      ...
      <div className="modal-content" style={{ width: 700, maxHeight: '80vh' }} onClick={e => e.stopPropagation()}>
        ...
        <div className="modal-body">
          ...
          <div style={{ marginTop: 8, fontSize: 11, color: 'var(--muted)' }}>
            Paste workflow code above, or upload a file:
            <input type="file" style={{ marginLeft: 8 }} onChange={e => {
