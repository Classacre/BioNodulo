...
const es = {
  ...
  runtimeArtifacts: {
    ...
    workflowTriggers: 'Triggers de workflow',
    evaluateTriggers: 'Evaluar triggers',
    evaluating: 'Evaluando...',
    submitDueTriggers: 'Enviar triggers pendientes',
    ...
    triggerFallback: 'Trigger de workflow',
    workflowTriggerRunFallback: 'Ejecucion de trigger de workflow',
    status: {
      approved: 'aprobado',
      rejected: 'rechazado',
      waiting: 'en espera',
    ...
    durableTriggerEvaluationAvailable: 'Evaluacion durable de triggers disponible',
    approve: 'Aprobar',
    reject: 'Rechazar',
    ...
    scheduleDueCount: '{{count}} trigger programado pendiente',
    scheduleDueCount_plural: '{{count}} triggers programados pendientes',
    scheduleDueCount_other: '{{count}} triggers programados pendientes',
    fileWatchDueCount: '{{count}} trigger de archivo pendiente',
    fileWatchDueCount_plural: '{{count}} triggers de archivo pendientes',
    fileWatchDueCount_other: '{{count}} triggers de archivo pendientes',
