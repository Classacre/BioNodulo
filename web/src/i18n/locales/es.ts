...
const es = {
  ...
  runtimeArtifacts: {
    title: 'Artefactos runtime',
    checkpoints: 'Puntos de control',
    pauseRequests: 'Solicitudes de pausa',
    workflowTriggers: 'Disparadores de workflow',
    ...
    triggerFallback: 'Disparador de workflow',
    workflowTriggerRunFallback: 'Ejecucion de disparador de workflow',
    status: {
      approved: 'aprobado',
      rejected: 'rechazado',
      waiting: 'en espera',
    ...
    doesNotSubmitRuns: 'No envia ejecuciones de workflow',
    ...
    triggerCount: '{{count}} disparador de workflow',
    triggerCount_plural: '{{count}} disparadores de workflow',
    triggerCount_other: '{{count}} disparadores de workflow',
    ...
    submittedRunCount: '{{count}} ejecucion de workflow enviada',
    submittedRunCount_plural: '{{count}} ejecuciones de workflow enviadas',
    submittedRunCount_other: '{{count}} ejecuciones de workflow enviadas',
    noCheckpointManifest: 'Todavia no hay manifiesto de checkpoints.',
    noCheckpoints: 'No hay checkpoints registrados.',
    noPauseRequests: 'No hay solicitudes de pausa.',
    noWorkflowTriggers: 'No hay triggers de workflow.',
  },
  hpc: {
    title: 'HPC',
