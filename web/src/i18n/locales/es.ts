...
const es = {
  ...
  topbar: {
    ...
    resumeCheckpoint: 'Checkpoint de reanudacion',
    noResumeCheckpoint: 'Sin checkpoint seleccionado',
    chooseCheckpoint: 'Elegir checkpoint',
    clearResumeCheckpoint: 'Borrar checkpoint de reanudacion',
  ...
  gettingStarted: {
    ...
    quickStartRunSuffix: 'para validar y ejecutar tu workflow.',
    ...
    aiAssistant: 'Asistente de IA',
    aiTipSuffix: 'para generar workflows desde descripciones en lenguaje natural.',
    recentsTitle: 'Workflows recientes',
    recentsAll: 'Todo',
  ...
  aiWorkflow: {
    ...
    localResponses: {
      rna: 'Para RNA-Seq, recomiendo: input_fastq -> fastp (recorte) -> STAR o HISAT2 (alinear) -> featureCounts (cuantificar). Agrega un nodo Sample Sheet para ejecuciones con multiples muestras. La plantilla RNA-Seq ya lo trae conectado.',
      variant: 'Para llamada de variantes: input_fastq -> fastp -> BWA-MEM -> samtools sort/index -> GATK HaplotypeCaller -> bcftools filter. La plantilla Variant Calling tambien incluye QC de BAM con samtools flagstat.',
      ...
      singleCell: 'Para single-cell: input_directory (FASTQs) + reference_transcriptome -> Cell Ranger Count. La plantilla Single Cell esta preconfigurada para datos 10x Genomics.',
      plotting: 'Para graficar: usa el nodo R Plot. Conecta un nodo DataFrame Builder con tus columnas x/y, elige scatter/line/bar/boxplot y configura color/titulo opcionales.',
      default: 'Puedo ayudarte a disenar workflows de bioinformatica. Prueba preguntar sobre RNA-Seq, llamada de variantes, ensamblaje, metagenomica, ChIP-Seq, QC, filogenetica o analisis single-cell.',
    },
  },
  panels: {
...
`,
  ...
  console: {
    ...
    actions: {
      ...
      workflowErrorLog: 'Error de workflow: {{message}}',
      workflowCancelledLog: 'Workflow cancelado',
  ...
  canvas: {
    ...
    subgraphBackToTopLevel: 'Volver al workflow de nivel superior',
