"""Retired static registry exports cannot bypass the shared editor API."""
import json

from fastapi.testclient import TestClient


def test_retired_registry_export_is_not_served_in_editor_mode(tmp_path, monkeypatch):
    ...
    with TestClient(server.create_app(), headers={"X-Bionodulo-Session": "static-asset-test-secret"}) as client:
        ...
        assert client.get("/biotools-registry/missing.json").status_code == 403
