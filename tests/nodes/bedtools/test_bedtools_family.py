...
from bionodulo.nodes.builtin.wrapped_bedtools import (
    BEDToolsAnnotateNode,
    BEDToolsBamToBedNode,
    BEDToolsBed12ToBed6Node,
    BEDToolsBedToBamNode,
    BEDToolsBedToIgvNode,
    BEDToolsBedpeToBamNode,
    BEDToolsClosestBedNode,
    BEDToolsClusterNode,
    BEDToolsComplementNode,
    BEDToolsCoverageNode,
    BEDToolsExpandNode,
    BEDToolsFisherNode,
    BEDToolsFlankNode,
    BEDToolsGenomeCoverageNode,
    BEDToolsGetFastaNode,
    BEDToolsGroupByNode,
    ...
    BEDToolsMergeNode,
    BEDToolsMultiCovNode,
    BEDToolsMultiIntersectNode,
    BEDToolsNucNode,
    BEDToolsOverlapBedNode,
    BEDToolsRandomNode,
    BEDToolsRelativeDistanceNode,
    BEDToolsShuffleNode,
    BEDToolsSlopNode,
    BEDToolsSortNode,
    BEDToolsSpacingNode,
    BEDToolsSubtractNode,
    BEDToolsTagBedNode,
