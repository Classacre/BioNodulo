"""addname — wrapped_core_data node(s). One tool per file (extracted from wrapped_core_data.py)."""
...
class AddInputNameAsColumnGalaxyNode(AddInputNameAsColumnNode):
    ...
    SEARCH_ALIASES = [BIONODULO_BUILTIN_ALIAS, 'addName', 'Add input name as column', 'add_input_name_as_column', 'dataset collection labels', 'history dataset name', 'sample label column', 'tabular label column']
