"""Shared ABRicate contracts for focused owners."""
# ruff: noqa: F403,F405
...
class ABRicateContractNode(ToolsIUCCommandContract):
    GIT_COMMIT = TOOLS_IUC_GIT_COMMIT
    SOURCE_URL = f"https://github.com/galaxyproject/tools-iuc/tree/{TOOLS_IUC_GIT_COMMIT}/tools/abricate"
    GALAXY_WRAPPER_SOURCE_URL = SOURCE_URL
    GALAXY_WRAPPER_VERSION = "1.4.0"
    PACKAGE_CONSTRAINT = "abricate==1.4.0"


class _ABRicateContract(ABRicateContractNode):
    """Mass screen contigs for antimicrobial resistance and virulence genes with ABRicate."""

    LEGACY_NODE_ID = "abricate"
...
class _ABRicateListContract(ABRicateContractNode):
    """List ABRicate databases available in the local installation."""

    LEGACY_NODE_ID = "abricate_list"
...
class _ABRicateSummaryContract(ABRicateContractNode):
    """Combine ABRicate reports into a gene presence and coverage matrix."""

    LEGACY_NODE_ID = "abricate_summary"
