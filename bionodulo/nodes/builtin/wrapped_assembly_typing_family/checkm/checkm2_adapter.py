"""Shared CheckM2 contract for its focused owner."""
# ruff: noqa: F403,F405
...
class CheckM2ContractNode(ToolsIUCCommandContract):
    GIT_COMMIT = TOOLS_IUC_GIT_COMMIT
    SOURCE_URL = f"https://github.com/galaxyproject/tools-iuc/tree/{TOOLS_IUC_GIT_COMMIT}/tools/checkm2"
    GALAXY_WRAPPER_SOURCE_URL = SOURCE_URL
    GALAXY_WRAPPER_VERSION = "1.1.0+galaxy0"
    PACKAGE_CONSTRAINT = "checkm2==1.1.0"


class _CheckM2Contract(CheckM2ContractNode):
    """Assess MAG, SAG, or isolate genome quality with CheckM2."""

    LEGACY_NODE_ID = "checkm2"
