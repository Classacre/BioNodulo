"""Shared GFA conversion contract for its focused owner."""
# ruff: noqa: F403,F405
...
class GFAContractNode(ToolsIUCCommandContract):
    GIT_COMMIT = TOOLS_IUC_GIT_COMMIT
    SOURCE_URL = (
        f"https://github.com/galaxyproject/tools-iuc/tree/{TOOLS_IUC_GIT_COMMIT}/tools/gfa_to_fa"
    )
    GALAXY_WRAPPER_SOURCE_URL = SOURCE_URL
    GALAXY_WRAPPER_VERSION = "0.1.2"
    PACKAGE_CONSTRAINT = "python wrapper gfa_to_fa==0.1.2"


class _GfaToFaContract(GFAContractNode):
    """Convert GFA segment records to FASTA with Galaxy's helper script."""

    LEGACY_NODE_ID = "gfa_to_fa"
