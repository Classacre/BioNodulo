...
SAMTOOLS_PACKAGE_VERSION_CONSTRAINT = f"=={SAMTOOLS_VERSION}"
SAMTOOLS_PACKAGE_CONSTRAINT = f"samtools{SAMTOOLS_PACKAGE_VERSION_CONSTRAINT}"
...
class SamtoolsCommandNode(CommandNode):
    ...
    CONDA_PACKAGE_CONSTRAINTS = {"samtools": SAMTOOLS_PACKAGE_VERSION_CONSTRAINT}
    PACKAGE_CONSTRAINTS = (SAMTOOLS_PACKAGE_CONSTRAINT,)
    PACKAGE_CONSTRAINT = SAMTOOLS_PACKAGE_CONSTRAINT
