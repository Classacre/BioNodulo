...
class CelloCircuitDesignNode(CommandNode):
    ...
    def INPUT_TYPES(cls) -> dict[str, dict[str, Any]]:
        return {
            "required": {
                "input_netlist": ("FILE", {"description": "Verilog netlist or placement JSON for the Cello application"}),
                "target_data_file": ("FILE", {"description": "Cello UCF target data JSON"}),
                "options_file": ("FILE", {"description": "Cello options CSV"}),
                "cello_exec_dir": ("DIRECTORY", {"description": "Path to the Cello-v2 exec directory containing run.py"}),
            },
            "optional": {
                "netlist_constraint_file": ("FILE", {"default": "", "description": "Optional Cello netlist constraints JSON"}),
                "java_args": ("STRING", {"default": "-Xms2G -Xmx5G", "description": "Java memory arguments passed to Cello"}),
                "application": ("STRING", {"default": "DNACompiler", "options": ["DNACompiler", "export"]}),
                "algo_name": ("STRING", {"default": "", "description": "Export algorithm name such as SBOL"}),
                "output_name": ("STRING", {"default": "", "description": "Optional output directory and filename stem"}),
            },
            "hidden": {
                "output": ("STRING", {}),
