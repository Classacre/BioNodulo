"""Focused comebin node contracts."""
# ruff: noqa: F403,F405
...
pin_contract(COMEBinNode)
pin_contract(COMEBinBamNode)

__all__ = ['COMEBinNode', 'COMEBinBamNode']
