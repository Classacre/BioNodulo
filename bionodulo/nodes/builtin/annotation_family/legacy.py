...
class FuncotateTableNode(CommandNode):
    ...
    LEGACY_NODE_ID = "funcotate_table"
...
class BcftoolsAnnotateNode(CommandNode):
    ...
    LEGACY_NODE_ID = "bcftools_annotate"
