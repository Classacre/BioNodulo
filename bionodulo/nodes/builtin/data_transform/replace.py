"""replace — data_transform node(s). One tool per file (extracted from data_transform.py)."""
...
class ReplaceTextNode(BaseNode):
    ...
    def INPUT_TYPES(cls) -> dict[str, dict[str, Any]]:
        return {'required': {'file': ('FILE', {'description': 'Text-based input file'}), 'search': ('STRING', {'default': '', 'description': 'Literal text or regex pattern to find'}), 'replace': ('STRING', {'default': '', 'description': 'Replacement text'})}, 'optional': {'use_regex': ('BOOLEAN', {'default': False}), 'case_sensitive': ('BOOLEAN', {'default': True}), 'whole_word': ('BOOLEAN', {'default': False}), 'limit_per_line': ('INT', {'default': 0, 'min': 0, 'max': 9999}), 'affected_lines_only': ('BOOLEAN', {'default': False}), 'output_extension': ('STRING', {'default': ''})}, 'hidden': {}}
