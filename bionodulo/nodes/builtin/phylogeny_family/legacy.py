...
class _EBIClustalOmegaContract(BaseNode):
    """Run Clustal Omega through the EMBL-EBI Job Dispatcher service."""

    LEGACY_NODE_ID = "ebi_clustal_omega"
...
class _PhylogeneticTreeBuilderContract(BaseNode):
    """Create a consensus tree manifest from one or more phylogenetic tree outputs."""

    LEGACY_NODE_ID = "phylogenetic_tree_builder"
