"""Focused graphlan node contracts."""
# ruff: noqa: F403,F405
...
class GraphlanAnnotateNode(CommandNode):
    ...
    LEGACY_NODE_ID = "graphlan_annotate"
...
pin_contract(GraphlanAnnotateNode)
pin_contract(GraphlanNode)

__all__ = ['GraphlanAnnotateNode', 'GraphlanNode']
