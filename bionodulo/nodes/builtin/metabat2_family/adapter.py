"""Focused metabat2 node contracts."""
# ruff: noqa: F403,F405
...
class MetaBAT2JgiSummarizeBamContigDepthsNode(CommandNode):
    ...
    LEGACY_NODE_ID = "metabat2_jgi_summarize_bam_contig_depths"
...
pin_contract(MetaBAT2Node)
pin_contract(MetaBAT2JgiSummarizeBamContigDepthsNode)
