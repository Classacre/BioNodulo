...
class FeatureCountsNode(CommandNode):
    ...
    def render_command(cls, inputs: dict[str, Any]) -> str:
        ...
        commands = [
            ...
            .replace("'${GALAXY_SLOTS:-2}'", "${GALAXY_SLOTS:-2}")
        ...
        if inputs.get("R"):
            commands.append(
                ...
                '-@ ${GALAXY_SLOTS:-2} -T "${TMPDIR:-.}" *.featureCounts.bam'
            )
    ...
    def INPUT_TYPES(cls) -> dict[str, dict[str, Any]]:
        return {
            "required": {
                "alignment": ("BAM", {"description": "SAM or BAM alignment file for read counting"}),
            },
            "optional": {
                "anno_select": (
                    "STRING",
                ...
                "threads": ("INT", {"default": 2, "min": 1, "advanced": True}),
