"""Focused datamash node contracts."""
# ruff: noqa: F403,F405
...
class DatamashTransposeNode(_DatamashBaseNode):
    ...
    LEGACY_NODE_ID = "datamash_transpose"
    VERSION = "1.9+galaxy1"
...
class DatamashReverseNode(_DatamashBaseNode):
    ...
    LEGACY_NODE_ID = "datamash_reverse"
    VERSION = "1.9+galaxy0"
...
pin_contract(DatamashOpsNode)
pin_contract(DatamashTransposeNode)
pin_contract(DatamashReverseNode)
