"""funcotator — annotation node(s). One tool per file (extracted from annotation.py)."""
...
class FuncotatorNode(FuncotateTableNode):
    ...
    SEARCH_ALIASES = ['funcotator', 'funcotate', 'gatk funcotator', 'cancer variants', 'somatic annotation', 'oncotator']
