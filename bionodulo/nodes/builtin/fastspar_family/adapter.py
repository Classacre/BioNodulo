"""Focused fastspar node contracts."""
# ruff: noqa: F403,F405
...
class FastSparReduceNode(CommandNode):
    ...
    LEGACY_NODE_ID = "fastspar_reduce"
...
class FastSparPvaluesNode(CommandNode):
    ...
    LEGACY_NODE_ID = "fastspar_pvalues"
...
pin_contract(FastSparNode)
pin_contract(FastSparReduceNode)
pin_contract(FastSparPvaluesNode)

__all__ = ['FastSparNode', 'FastSparReduceNode', 'FastSparPvaluesNode']
