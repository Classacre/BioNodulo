    ...
    <div class="container">
        ...
        <div class="summary">
            <div class="summary-card">
                <h3>Total Nodes</h3>
                <div class="value">{sum(1 for n in nodes.values() if n.get('type') != 'note')}</div>
            </div>
            <div class="summary-card">
                <h3>Completed</h3>
        ...
        <div class="footer">
            <p>Generated by BioNodulo v{__version__} on {datetime.now(timezone.utc).strftime('%Y-%m-%d %H:%M:%S UTC')}</p>
        </div>
    </div>
</body>
</html>"""
